...
describe('Campaigns', () => {
    ...
    it('can create a payment request', async () => {
        await campaign.methods.createRequest('Pay Salary', '100', accounts[1]).send({
            from: accounts[0],
            gas: '1000000'
        });
    ...
    it('processes request', async() => {
        ...
        await campaign.methods.createRequest('Pay Salary',web3.utils.toWei('5','ether'),accounts[1]).send({
            from: accounts[0],
            gas: '1000000'
        });
